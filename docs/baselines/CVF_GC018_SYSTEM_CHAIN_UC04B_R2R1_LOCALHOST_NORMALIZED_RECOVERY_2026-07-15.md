...
| literalTokensReviewed | `Status: CLOSED_PASS_BOUNDED`; `Source Verification Block`; `Dependency Release Evidence`; `Public Export Disposition` |
...
| Work order status | paired R2R1 work order | `CLOSED_PASS_BOUNDED` | PASS |
