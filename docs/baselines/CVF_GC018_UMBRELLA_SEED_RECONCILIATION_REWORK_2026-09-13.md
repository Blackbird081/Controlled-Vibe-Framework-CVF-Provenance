...
Release docs/work_orders/CVF_AGENT_WORK_ORDER_UMBRELLA_SEED_RECONCILIATION_REWORK_2026-09-13.md for one F1-F4 evidence repair after reviewer decision docs/reviews/CVF_UMBRELLA_SEED_RECONCILIATION_COMPLETION_2026-09-13.md. Preserve original worker return; fix audit and create new return. Same umbrella metadata scope, no acquisition or implementation.
...
Worker owns docs/audits/CVF_UMBRELLA_SEED_RECONCILIATION_2026-09-13.json and docs/reviews/CVF_UMBRELLA_SEED_RECONCILIATION_REWORK_WORKER_RETURN_2026-09-13.md only. Local owns the pair, docs/audits/CVF_UMBRELLA_SEED_PROVENANCE_RECEIPT_2026-09-13.json, docs/reviews/CVF_UMBRELLA_SEED_RECONCILIATION_REWORK_COMPLETION_2026-09-13.md and the seven continuity paths above. External inputs remain unchanged.

## Source Verification Block

| Fact | Source file | Verified section | Disposition |
|---|---|---|---|
| Same metadata scope | docs/work_orders/CVF_AGENT_WORK_ORDER_UMBRELLA_SEED_RECONCILIATION_2026-09-13.md | Acceptance Criteria | ACCEPT |
| Consolidated correction | docs/reviews/CVF_UMBRELLA_SEED_RECONCILIATION_COMPLETION_2026-09-13.md | Findings / Position and Decision | ACCEPT |

## Acceptance Criteria

Original metadata contract and all F1-F4 check clauses in consolidated review. No inferred source/obligation acceptance; preserve raw return and provide new gated repair evidence.

## Evidence / Verification

At f5bfdffdda4041ce7277026b3ec83dae89eff43d, original two worker outputs were untracked. Reviewer-return preflight PASS; semantic findings F1-F4 require repair. Original input provenance receipt remains unchanged. Required pre-dispatch, pre-commit and split closure gates control release; no success inferred from worker gate alone.
...
## Rework Ownership Clarification

Worker may repair docs/audits/CVF_UMBRELLA_SEED_RECONCILIATION_2026-09-13.json and create docs/reviews/CVF_UMBRELLA_SEED_RECONCILIATION_REWORK_WORKER_RETURN_2026-09-13.md only. Original docs/reviews/CVF_UMBRELLA_SEED_RECONCILIATION_WORKER_RETURN_2026-09-13.md remains immutable. Local owns docs/reviews/CVF_UMBRELLA_SEED_RECONCILIATION_COMPLETION_2026-09-13.md, this pair and docs/reviews/CVF_UMBRELLA_SEED_RECONCILIATION_REWORK_COMPLETION_2026-09-13.md plus seven continuity paths already enumerated. Worker cannot edit authority hashes.
