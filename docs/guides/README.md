...
| [CVF 5-Minute RC Setup](CVF_5_MINUTE_RC_SETUP.md) | RC1 first-run operators on Windows | 5 min |
| [CVF Deploy Guide](CVF_DEPLOY_GUIDE.md) | Public deploy operators | 15 min |
| [Non-Coder First Receipt](CVF_NON_CODER_SETUP_GUIDE_2026-05-24.md) | Non-coders and small teams proving a governed receipt path | 10 min |

## Where to Start

- **New to CVF?** → [Solo Developer](solo-developer.md)
- **Trying RC1 locally?** → [CVF 5-Minute RC Setup](CVF_5_MINUTE_RC_SETUP.md)
...
- **Non-coder first receipt?** → [Non-Coder First Receipt](CVF_NON_CODER_SETUP_GUIDE_2026-05-24.md)
