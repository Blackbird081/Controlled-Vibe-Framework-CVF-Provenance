# CVF Agent Work Order - MFRP-P3-R1A Committed Oracle Ratification
...
Batch ID: MFRP-P3-R1A

Dispatch base head: `6dd4b1e8618257aef872c661eaaaef008b0196d0`
...
Role: bounded provider-free R1A oracle evidence worker. The worker authors a
normative JSON oracle and its evidence return; the reviewer owns ratification.

Canonical packet: `docs/work_orders/CVF_AGENT_WORK_ORDER_MFRP_P3_R1A_COMMITTED_ORACLE_RATIFICATION_2026-09-01.md`.

Commit mode: WORKER_MUST_NOT_COMMIT.

executionBaseHead: WORKER_MUST_CAPTURE_AT_START.

Current-time notes: the two-tranche direction and four binding amendments are
accepted at material commit `51d1e4ebeedc5f9995433b68043e3985cd2aa616`;
dispatch continuity is `6dd4b1e8618257aef872c661eaaaef008b0196d0`.
The operator explicitly opened R1A authoring on 2026-09-01. R1B remains closed.

Do-not-misread notes: this is static oracle authoring, not replay. Do not build
a receipt, invoke either P2 seam on a case, create a runner/test, record an
observed result, modify P2, count unrepresentable cases as detected, or open a
successor.
...
Worker return path: `docs/reviews/CVF_MFRP_P3_R1A_COMMITTED_ORACLE_RATIFICATION_WORKER_RETURN_2026-09-01.md`

successorTrancheOpened: NO

## Purpose

Create a committed-oracle candidate for later actual-seam replay by converting
the eighteen roadmap families into source-bound normative cases with exact
static feasibility dispositions against current P2 source. Preserve all gaps
honestly without executing or predicting R1B observations.
...
parentAssignmentId: MFRP-P3-R1A
reviewRoundCount: 0
...
```json
{
  ...
  "blockerDelta": {
    ...
    "resolved": [],
    "retained": [],
    "new": ["r1a-oracle-not-yet-ratified"],
    "reopened": [],
  ...
  "claims": [{
    "claimId": "MFRP-P3-R1A-DISPATCH-STATIC-ORACLE",
    "claimClass": "DOCUMENTATION_ONLY",
    "proofClass": "PROPOSAL_ONLY_NO_RUNTIME_READINESS",
    "evidenceRef": "docs/baselines/CVF_GC018_MFRP_P3_R1A_COMMITTED_ORACLE_RATIFICATION_2026-09-01.md"
  }],
...
|---|---|---|
| operator R1A authoring instruction | current operator message dated 2026-09-01 | ACCEPT |
...
| paired GC-018 baseline | `docs/baselines/CVF_GC018_MFRP_P3_R1A_COMMITTED_ORACLE_RATIFICATION_2026-09-01.md`; SHA-256 `ed0811e913cbd6229aba4fa5662fe0ebf043d79dd02e0002872a932d85066b32` | ACCEPT |
...
Target: exactly two new R1A artifacts. The worker reads the nine pinned sources
and calculates static source/field-route evidence. The worker must not import
or invoke P2 functions for case execution.
...
The worker records both hashes under `p2SeamIdentity`. Static inspection is
allowed; importing/invoking them on constructed receipts is forbidden.
...
|---|---|
| `governance/compat/fixtures/mfrp_p3_r1a_actual_seam_replay_oracle.json` | CREATE one UTF-8 JSON normative oracle with exact sources, seam identities, sets, cases and static feasibility evidence |
| `docs/reviews/CVF_MFRP_P3_R1A_COMMITTED_ORACLE_RATIFICATION_WORKER_RETURN_2026-09-01.md` | CREATE checker-safe no-commit evidence return with hash/set/feasibility reconciliation and terminal candidate |
...
| Path | Owner | Mode |
|---|---|---|
| `governance/compat/fixtures/mfrp_p3_r1a_actual_seam_replay_oracle.json` | worker authors; reviewer verifies | CREATE |
| `docs/reviews/CVF_MFRP_P3_R1A_COMMITTED_ORACLE_RATIFICATION_WORKER_RETURN_2026-09-01.md` | worker authors; reviewer repairs/accepts | CREATE |
...
- Do not invoke `_validate_receipt_integrity`,
  `build_machine_verification_readout` or `machine_readout_to_dict` on a case.
- Do not build or write a receipt, mutated payload, replay output or result
  ledger.
- Do not create Python/helper/test/cache/temp artifacts in the repository.
...
python -m json.tool governance/compat/fixtures/mfrp_p3_r1a_actual_seam_replay_oracle.json
python governance/compat/run_worker_return_fast_gate.py
python governance/compat/run_agent_autorun_workflow_gate.py --phase pre-review --base <executionBaseHead> --head HEAD
...
priorVerificationArtifact: `docs/reviews/CVF_MFRP_P3_R1_EXTERNAL_FINDING_ABSORPTION_AND_DESIGN_RECONCILIATION_2026-09-01.md`

priorVerificationAnchor: `51d1e4ebeedc5f9995433b68043e3985cd2aa616`
...
| token search | `rg -n "MFRP-P3-R1A|actualSeamReplayOracle|mfrp_p3_r1a_actual_seam_replay_oracle" docs CVF_SESSION governance/compat` | only design/reconciliation/rejected-history references; no active oracle owner |
...
| paired baseline | dispatch baseline | `docs/baselines/CVF_GC018_MFRP_P3_R1A_COMMITTED_ORACLE_RATIFICATION_2026-09-01.md` | Decision, contracts, exact manifests and stops | SHA-256 `ed0811e913cbd6229aba4fa5662fe0ebf043d79dd02e0002872a932d85066b32` | GC-018 R1A baseline | ACCEPT |
...
| Field | Value |
|---|---|
| scaffoldHelperCommand | `python governance/compat/build_dispatch_packet_scaffold.py --packet-kind protected-governance-path --batch-id MFRP-P3-R1A --title "Committed Oracle Ratification" --date 2026-09-01 --base 6dd4b1e8618257aef872c661eaaaef008b0196d0 --commit-mode WORKER_MUST_NOT_COMMIT --dispatch-kind INITIAL --dispatch-surface INTERNAL_AGENT --review-round-count 0 --cumulative-external-invocation-count 0 --external-invocation-ceiling 1 --scec-problem-key mfrp-p3-r1-oracle --scec-chain-mode SUCCESSOR --scec-chain-ordinal 1 --scec-predecessor-path docs/reviews/CVF_MFRP_P3_R1_EXTERNAL_FINDING_ABSORPTION_AND_DESIGN_RECONCILIATION_2026-09-01.md --scec-predecessor-sha256 8d4d782ac212de13f404021ab4256664696d97321377b1978749a1b08d9ab797 --scec-required-disposition CONTINUE_BOUNDED --scec-successor-scope INITIAL_BOUNDED --stdout` |
...
- `governance/compat/fixtures/mfrp_p3_r1a_actual_seam_replay_oracle.json`
...
| baseHeadFor(phase) | dispatchBaseHead=`6dd4b1e8618257aef872c661eaaaef008b0196d0`; executionBaseHead=worker capture; closureBaseHead=reviewer capture |
...
workerReturnPath: `docs/reviews/CVF_MFRP_P3_R1A_COMMITTED_ORACLE_RATIFICATION_WORKER_RETURN_2026-09-01.md`
...
- [ ] worker-return fast gate and pre-review bundle pass;
...
| Session or invocation | MFRP-P3-R1A dispatch authoring, 2026-09-01 |
...
| Before status evidence | HEAD `6dd4b1e8618257aef872c661eaaaef008b0196d0`; clean worktree confirmed; all four proposed paths absent |
...
| Invocation ID | `mfrp-p3-r1a-dispatch-authoring-2026-09-01` |
| Expected manifest | `docs/baselines/CVF_GC018_MFRP_P3_R1A_COMMITTED_ORACLE_RATIFICATION_2026-09-01.md`; `docs/work_orders/CVF_AGENT_WORK_ORDER_MFRP_P3_R1A_COMMITTED_ORACLE_RATIFICATION_2026-09-01.md` |
| Actual changed set | `docs/baselines/CVF_GC018_MFRP_P3_R1A_COMMITTED_ORACLE_RATIFICATION_2026-09-01.md`; `docs/work_orders/CVF_AGENT_WORK_ORDER_MFRP_P3_R1A_COMMITTED_ORACLE_RATIFICATION_2026-09-01.md` |
