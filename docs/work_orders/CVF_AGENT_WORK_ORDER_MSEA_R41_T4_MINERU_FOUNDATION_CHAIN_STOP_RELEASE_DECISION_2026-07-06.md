# CVF Agent Work Order - MSEA R41 T4 MinerU Foundation Chain Stop Release Decision
...
Worker return path: `docs/reviews/CVF_MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION_WORKER_RETURN_2026-07-06.md`

## Dispatch Prompt Envelope

Role: delegated docs-only stop/release-decision worker for MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION.

Canonical packet: `docs/work_orders/CVF_AGENT_WORK_ORDER_MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION_2026-07-06.md`

Commit mode: WORKER_MUST_NOT_COMMIT.

executionBaseHead: WORKER_MUST_CAPTURE_AT_START.

Current-time notes: artifact date is 2026-07-06; current session state points from accepted R41-T3 completion review `docs/reviews/CVF_MSEA_R41_T3_MINERU_PERSISTENCE_HARNESS_READINESS_DECISION_COMPLETION_2026-07-06.md` at material commit `7c5d94ac5` to R41-T4 stop/release decision authoring.
...
Required first actions: read required startup files, guard orientation, literal gotchas, this packet, the paired GC-018 baseline, accepted R38-R41 artifacts, source rows in the Source Verification Block, and all checker source listed in the Checker Source Read-Ahead Block before writing any artifact.
...
Execute the R41-T4 docs-only stop/release decision for the MinerU to
memory/scanlayer foundation chain. The worker must decide whether the current
system-chain foundation should stop as a bounded candidate, whether only a
fresh reopen authority packet is justified, or whether a different held lane
should be selected. The worker must preserve all R39 and R41 authority holds
unless a source-verified accepted artifact already resolves them.
...
| manualEditsAfterScaffold | Replaced placeholders with R41-T4 stop/release-decision scope, no-commit handoff controls, worker output manifest, dependency-release evidence, source verification, ADIF disclosure, and private-only boundaries. |
...
| Field | Disposition |
| --- | --- |
| Intake source | Operator asked to continue after accepted R41-T3 closure and active session next allowed move |
| intake summary | Docs-only stop/release decision for MinerU foundation chain |
| scope classification | governed stop/release decision dispatch; no source/test edit, runtime, provider/live, public-sync, production release, or persistence invocation |
...
| workerRole | delegated worker performs docs-only stop/release evidence synthesis |
...
| Authority | Evidence |
| --- | --- |
| Operator instruction | User said to continue after R41-T3 worker execution and closure flow. |
| Active session front door | `CVF_SESSION_MEMORY.md` records R41-T3 closure and R41-T4/stop next-move posture. |
| Active session state | `CVF_SESSION/ACTIVE_SESSION_STATE.json` points to active handoff `AGENT_HANDOFF_V37_2026-07-06.md`. |
| Active handoff | `AGENT_HANDOFF_V37_2026-07-06.md` records the R41-T3 closed mode and no-runtime boundary. |
| Accepted R38 system-chain closure | `docs/reviews/CVF_MSEA_R38_T1_T4_MINERU_TO_MEMORY_SCANLAYER_SYSTEM_CHAIN_CLOSURE_AUDIT_COMPLETION_2026-07-06.md` selected foundation/internal system-chain stop. |
| Accepted R39 production route decision | `docs/reviews/CVF_MSEA_R39_T1_MINERU_PRODUCTION_MEMORY_RAG_ROUTE_RELEASE_AUTHORITY_DECISION_COMPLETION_2026-07-06.md` kept production Memory/RAG route release held. |
| Accepted R40 bounded proof | `docs/reviews/CVF_MSEA_R40_T1_MINERU_SYSTEM_CHAIN_PROVIDER_LIVE_PROOF_COMPLETION_2026-07-06.md` accepted bounded private proof only. |
| Accepted R41-T1, R41-T2, R41-T3 decisions | Completion reviews and matrices named in Dependency Release Evidence. |
| Paired GC-018 baseline | `docs/baselines/CVF_GC018_MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION_2026-07-06.md` |

## Dependency Release Evidence

| Dependency | Evidence artifact | Commit | Release disposition | T4 consequence |
| --- | --- | --- | --- | --- |
| R38 system-chain closure audit | `docs/reviews/CVF_MSEA_R38_T1_T4_MINERU_TO_MEMORY_SCANLAYER_SYSTEM_CHAIN_CLOSURE_AUDIT_COMPLETION_2026-07-06.md` | `42a0f1f02` | Foundation/internal system-chain only | T4 may summarize bounded foundation status, not production readiness. |
| R39 production Memory/RAG route release authority decision | `docs/reviews/CVF_MSEA_R39_T1_MINERU_PRODUCTION_MEMORY_RAG_ROUTE_RELEASE_AUTHORITY_DECISION_COMPLETION_2026-07-06.md` | `bdc865ce0` | Held pending authority gaps | T4 must not release production Memory/RAG route. |
...
| R41-T1 file-backed persistence release authority decision | `docs/reviews/CVF_MSEA_R41_T1_MINERU_FILE_BACKED_PERSISTENCE_RELEASE_AUTHORITY_DECISION_COMPLETION_2026-07-06.md` | `51216fb9a` | Held pending authority gaps | T4 must keep file-backed persistence release held. |
...
| --- | --- | --- | --- | --- |
| R41-T4 may decide whether the foundation chain remains a bounded candidate | Purpose; Mission; Dependency Release Evidence | `selectedR41T4Disposition` in decision matrix | Source verification rows for R38 through R41-T3 | PASS |
| R39 and R41 authority holds remain active unless accepted evidence resolves them | Source Verification Block; Mission | `foundationChainReleaseBoundary` | Worker checks accepted R39 and R41 artifacts | PASS |
...
- `R41_T4_FOUNDATION_CHAIN_REOPEN_AUTHORITY_PACKET_JUSTIFIED`
- `R41_T4_FOUNDATION_CHAIN_DIFFERENT_HELD_LANE_SELECTION_RECOMMENDED`

The worker must select `R41_T4_FOUNDATION_CHAIN_STOP_BOUNDED_CANDIDATE` unless
it can cite accepted, source-verified evidence that resolves the relevant R39
and R41 authority gaps or shows a different held lane now has higher bounded
...
- Read only CVF-governed startup files, the paired GC-018 baseline, this work order, accepted R38-R41 artifacts, and source files named in the Source Verification Block if fresh verification is necessary.
...
- ADIF-0024 - Worker must provide fresh gates, workspace hygiene, static-analysis diagnostic handling, and stray provider-local file disclosure.
...
| `docs/baselines/CVF_GC018_MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION_2026-07-06.md` | Paired GC-018 dispatch baseline. |
| `docs/reviews/CVF_MSEA_R38_T1_T4_MINERU_TO_MEMORY_SCANLAYER_SYSTEM_CHAIN_CLOSURE_AUDIT_COMPLETION_2026-07-06.md` | Accepted R38 system-chain closure boundary. |
| `docs/reference/CVF_MSEA_R39_T1_MINERU_PRODUCTION_MEMORY_RAG_ROUTE_RELEASE_AUTHORITY_DECISION_MATRIX_2026-07-06.md` | Accepted R39 held production route decision. |
| `docs/reviews/CVF_MSEA_R40_T1_MINERU_SYSTEM_CHAIN_PROVIDER_LIVE_PROOF_COMPLETION_2026-07-06.md` | Accepted bounded proof boundary. |
| `docs/reference/CVF_MSEA_R41_T1_MINERU_FILE_BACKED_PERSISTENCE_RELEASE_AUTHORITY_DECISION_MATRIX_2026-07-06.md` | Accepted R41-T1 held persistence release decision. |
| `docs/reference/CVF_MSEA_R41_T2_MINERU_PERSISTENCE_MODE_AUTHORIZATION_DECISION_MATRIX_2026-07-06.md` | Accepted R41-T2 held authorization decision. |
| `docs/reference/CVF_MSEA_R41_T3_MINERU_PERSISTENCE_HARNESS_READINESS_DECISION_MATRIX_2026-07-06.md` | Accepted R41-T3 blocked harness readiness decision. |
| Source files named in Source Verification Block if worker recomputes source anchors | Required source facts for any stop, reopen, or lane-selection claim. |
...
| `python governance/compat/run_worker_return_scaffold.py --write docs/reviews/CVF_MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION_WORKER_RETURN_2026-07-06.md --title "MSEA R41 T4 MinerU Foundation Chain Stop Release Decision Worker Return"` | Create checker-safe worker-return scaffold. |
...
| --- | --- | --- |
| `docs/reference/CVF_MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION_MATRIX_2026-07-06.md` | worker | Allowed to create only. |
| `docs/reviews/CVF_MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION_WORKER_RETURN_2026-07-06.md` | worker | Allowed to create only. |
...
| Current T4 dispatch is operator-selected but remains docs-only and no-runtime | DOC_ONLY_NEW | `docs/work_orders/CVF_AGENT_WORK_ORDER_MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION_2026-07-06.md` | Purpose and Mission sections | `selectedR41T4Disposition` | R41-T4 work order | ACCEPT |
...
| Disposition | NOT_APPLICABLE_WITH_REASON: this work order uses only CVF-governed repository sources and accepted R38-R41 artifacts. |
...
| Applicability | N/A with reason: the word foundation names the MinerU system-chain subject matter only; this work order does not create, split, relocate, refactor, or index durable governance foundation files. |
...
| baseHeadFor(phase) | dispatchBaseHead=9046647dc; executionBaseHead=WORKER_MUST_CAPTURE_AT_START; closureBaseHead=REVIEWER_TO_SET |
...
| crossBatchIsolation | Dispatch begins from clean worktree at 9046647dc; worker must disclose any unrelated or provider-local stray files and leave them unstaged. |
...
| reviewerOwnedClosurePaths | `docs/reviews/CVF_MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION_COMPLETION_2026-07-06.md`; this work order if status changes; active session surfaces only if reviewer accepts closure. |
...
| --- | --- |
| `docs/reference/CVF_MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION_MATRIX_2026-07-06.md` | Create as source-verified stop/release decision matrix with exactly one selected R41-T4 disposition token and explicit bounded-candidate, reopen, or lane-selection rationale. |
| `docs/reviews/CVF_MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION_WORKER_RETURN_2026-07-06.md` | Create from worker-return scaffold, include required review headings and evidence, pass fast gate, and leave uncommitted. |

## Worker Return Packet Shape Contract

workerReturnPath: `docs/reviews/CVF_MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION_WORKER_RETURN_2026-07-06.md`
...
python governance/compat/run_worker_return_scaffold.py --write docs/reviews/CVF_MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION_WORKER_RETURN_2026-07-06.md --title "MSEA R41 T4 MinerU Foundation Chain Stop Release Decision Worker Return"
...
| Session or invocation | MSEA_R41_T4_MINERU_FOUNDATION_CHAIN_STOP_RELEASE_DECISION dispatch authoring, 2026-07-06 |
...
| Allowed scope source | Operator continuation request plus R41-T3 accepted closure next allowed move |
| Before status evidence | clean worktree at dispatch base 9046647dc; `git status --short --untracked-files=all` showed no changed paths except sandbox global-ignore warnings |
...
| Invocation ID | `msea-r41-t4-foundation-chain-stop-release-decision-dispatch-2026-07-06` |
...
| Field | Value |
| --- | --- |
| claimScope | docs-only R41-T4 stop/release dispatch for MinerU foundation-chain bounded-candidate decision |
...
| claimLanguage | The packet asks for a source-verified stop/release decision, not implementation or proof of production behavior |
...
| 2 | Accepted R38 through R41-T3 artifacts | Decision matrix draft | Stop if evidence does not support exactly one R41-T4 disposition. |
...
| Decision | Exactly one R41-T4 disposition token in the matrix. |
...
- Decision matrix selects exactly one R41-T4 disposition token.
- If selecting reopen-authority-packet-justified, matrix names the exact held authority gap, accepted source evidence, and concrete reopen condition.
- If selecting bounded-candidate stop, matrix names the unresolved authority gaps and explains why no further system-chain tranche should proceed now.
- If selecting different held lane, matrix names the lane and why it is higher value without entering use-case/legal scope.
- Source Verification rows cite existing source files or accepted R38-R41 artifacts and use symbol-only cells.
...
- Missing or multiple selected R41-T4 disposition tokens.
- Reopen-authority-packet-justified is selected without source-backed evidence satisfying the named held authority gap.
...
This work order authorizes only a docs-only R41-T4 stop/release decision worker
