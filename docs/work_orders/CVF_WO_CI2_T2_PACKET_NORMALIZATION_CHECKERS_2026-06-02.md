...
| Existing checker import sanity | `python governance/compat/check_corpus_intelligence_classification.py --base 65a0620f --head HEAD` | exit 0 |
...
python governance/compat/check_core_guard_self_protection.py --base <baseHead> --head HEAD --enforce
