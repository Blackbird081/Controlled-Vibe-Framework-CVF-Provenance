# CVF Agent Work Order - WP-ARCH-003 RABA-T0 Root Authority Source Verification
...
dispatchBaseHead: dbf0f1bcc77286fe3429bf582d46df7d1f9edbd2
...
Role: external worker performing fresh, evidence-first root-authority source
verification for `WP-ARCH-003-RABA-T0`. A separate orchestrator/reviewer owns
semantic acceptance, repair findings, completion review and all commits.

Canonical packet:
`docs/work_orders/CVF_AGENT_WORK_ORDER_WP_ARCH_003_RABA_T0_ROOT_AUTHORITY_SOURCE_VERIFICATION_2026-09-08.md`.

Paired baseline:
`docs/baselines/CVF_GC018_WP_ARCH_003_RABA_T0_ROOT_AUTHORITY_SOURCE_VERIFICATION_2026-09-08.md`.

Commit mode: WORKER_MUST_NOT_COMMIT.

executionBaseHead: WORKER_MUST_CAPTURE_AT_START.

Current-time notes: RABA-T0 is a new parent with cumulative external use 0 and
ceiling 1. The AR1 parent remains exhausted at 2/2 and is not reopened. The
operator must explicitly relay this committed packet before the one authorized
external invocation begins.

Do-not-misread notes: this is not AR1-R2 and not an implementation task. Do not
...
Determine from current governed source whether CVF has a truthful higher-
authority approval issuer, an approval receipt/verifier with freshness and
replay semantics, a non-self-attested principal/task/file-scope binding, one
canonical owner per responsibility, and a real runtime consumer. The result is
an evidence and owner decision, not an integrated contract design.
...
2. RABA roadmap
   `docs/roadmaps/CVF_WP_ARCH_003_ROOT_AUTHORITY_AND_PRINCIPAL_SCOPE_ARCHITECTURE_REASSESSMENT_ROADMAP_2026-09-08.md`
   at commit `cd56ac953d411f6781758d2fe625ea88a9545644`.
3. Terminal AR1 R1 completion review
   `docs/reviews/CVF_WP_ARCH_003_AR1_R1_CANONICAL_OWNER_RUNTIME_PATH_DESIGN_REWORK_COMPLETION_2026-09-08.md`
   at commit `8ab5a361cbacacbc5f9c1d9e78590342a1173a23`, file SHA-256
   `6dbcc7b4fad60c2cee2184322e8ebd053ae76db9288b05ad50389667c5e1bd40`.
4. Operator authorization for RABA-T0 packet authoring on 2026-09-08.
...
|---|---|---|---|
| RABA roadmap | `docs/roadmaps/CVF_WP_ARCH_003_ROOT_AUTHORITY_AND_PRINCIPAL_SCOPE_ARCHITECTURE_REASSESSMENT_ROADMAP_2026-09-08.md` at commit `cd56ac953d411f6781758d2fe625ea88a9545644`; SHA-256 `613cabc5a84e60de7f8d8725cc939f49f8cd2f35e7d61a0051d2cb51f84e31c5` | `OPERATOR_AUTHORIZED_T0_PACKET_REQUIRED` | ACCEPT |
| terminal rejection fact | `docs/reviews/CVF_WP_ARCH_003_AR1_R1_CANONICAL_OWNER_RUNTIME_PATH_DESIGN_REWORK_COMPLETION_2026-09-08.md` at commit `8ab5a361cbacacbc5f9c1d9e78590342a1173a23`; SHA-256 `6dbcc7b4fad60c2cee2184322e8ebd053ae76db9288b05ad50389667c5e1bd40` | `CLOSED_REJECTED` | ACCEPT |
...
```json
{
  ...
  "problemKey": "WP_ARCH_003_ROOT_AUTHORITY_PRINCIPAL_SCOPE",
  "chainMode": "INITIAL",
  "chainOrdinal": 0,
  "predecessor": null,
  "blockerDelta": {
    ...
    "retained": [],
    "new": [
      "NO_TRUSTED_APPROVAL_ISSUER",
      "UNBOUND_APPROVAL_SEMANTICS",
      "SELF_ATTESTED_PRINCIPAL_SCOPE",
      "NO_AUTHORITY_EXPANSION_RUNTIME_CONSUMER",
      "MANIFEST_MATRIX_DIVERGENCE"
    ],
    "reopened": [],
    "current": [
      "NO_TRUSTED_APPROVAL_ISSUER",
  ...
  "claims": [
    {
      "claimId": "WP-ARCH-003-RABA-T0-DISPATCH",
      "claimClass": "DOCUMENTATION_ONLY",
      "proofClass": "PROPOSAL_ONLY_NO_RUNTIME_READINESS",
      "evidenceRef": "docs/roadmaps/CVF_WP_ARCH_003_ROOT_AUTHORITY_AND_PRINCIPAL_SCOPE_ARCHITECTURE_REASSESSMENT_ROADMAP_2026-09-08.md"
    }
  ],
...
3. This work order and
   `docs/baselines/CVF_GC018_WP_ARCH_003_RABA_T0_ROOT_AUTHORITY_SOURCE_VERIFICATION_2026-09-08.md`
   in full.
4. `docs/roadmaps/CVF_WP_ARCH_003_ROOT_AUTHORITY_AND_PRINCIPAL_SCOPE_ARCHITECTURE_REASSESSMENT_ROADMAP_2026-09-08.md`.
5. `docs/reviews/CVF_WP_ARCH_003_AR1_R1_CANONICAL_OWNER_RUNTIME_PATH_DESIGN_REWORK_COMPLETION_2026-09-08.md`.
...
the orchestrator; staging is empty; only any operator-disclosed protected
historical evidence may already be present; the pre-implementation gate exits
zero. Capture the full SHA as `executionBaseHead` before writing.

## Task Governance Routing Manifest

```json
{"schemaVersion":"cvf.taskGovernanceManifest.v1","taskId":"WP-ARCH-003-RABA-T0-ROOT-AUTHORITY-SOURCE-VERIFICATION","requestedProfile":"P3_ELEVATED","classification":{"taskKind":"DOC_CHANGE","authorityImpact":"USES_EXISTING_OWNER","externalEffect":"NONE","dataSensitivity":"PRIVATE_REPO","reversibility":"GIT_REVERSIBLE","sourceScale":"BOUNDED_CLUSTER","delegation":"MULTI_ROLE_NO_COMMIT","novelty":"OWNER_COMPOSITION"},"pathFamilies":["docs/baselines/","docs/assessments/","docs/reviews/"],"claims":["bounded source-verification and owner decision"],"requiredProof":["six-question source ledger","trust-chain map","owner decision","negative searches","exact-two no-commit return"],"operatorCheckpoints":["explicit relay","reviewer semantic disposition"],"forbiddenEffects":["runtime or test mutation","provider or live call","MFRP mutation","public sync","deployment","worker commit"],"sourceEvidence":{"selectedFilesFullyRead":true,"corpusReceiptRef":"N/A with reason: bounded named source cluster; no complete-corpus claim","completenessClaimChanged":false}}
```
...
| exact terminal state | one of two RABA-T0 terminal tokens | assessment and return agree | reviewer confirms or rejects |

## Scope / Target / Owner Boundary

Allowed scope:

- `docs/assessments/CVF_WP_ARCH_003_RABA_T0_ROOT_AUTHORITY_SOURCE_VERIFICATION_2026-09-08.md`
- `docs/reviews/CVF_WP_ARCH_003_RABA_T0_ROOT_AUTHORITY_SOURCE_VERIFICATION_WORKER_RETURN_2026-09-08.md`
...
- both rejected AR1 worker files and any temporary repository note;
...
|---|---|---|---|---|
| `docs/assessments/CVF_WP_ARCH_003_RABA_T0_ROOT_AUTHORITY_SOURCE_VERIFICATION_2026-09-08.md` | CREATE | external worker | YES | complete source ledger, trust chain, owner decision and exact terminal outcome |
| `docs/reviews/CVF_WP_ARCH_003_RABA_T0_ROOT_AUTHORITY_SOURCE_VERIFICATION_WORKER_RETURN_2026-09-08.md` | CREATE | external worker | YES | commands, hashes, exact changed-set, convergence fields and no-commit return |

## Work-Order Fulfillment Manifest

| Required artifact | Planned action | Handoff state | Acceptance owner |
|---|---|---|---|
| RABA-T0 assessment | create one new untracked file | present, validated, unstaged and uncommitted | orchestrator/reviewer |
| RABA-T0 worker return | create one new untracked file | present, validated, unstaged and uncommitted | orchestrator/reviewer |
...
|---|---|---|
| RABA-T0 assessment path | create and repair before return | inspect; no silent semantic rewrite |
| RABA-T0 worker-return path | create and repair before return | inspect; no conversion into completion review |
...
RABA-T0-A01 through RABA-T0-A14 are conjunctive except that a source-proven park
...
|---|---|---|
| RABA-T0-A01 | unchanged execution HEAD, empty staging and exactly two new worker paths | `BLOCKED_WITH_REASON` |
| RABA-T0-A02 | all six root questions have exact answers or source-proven park reasons | `RETURN_TO_EVIDENCE` |
| RABA-T0-A03 | issuer provenance is not inferred from a deterministic content hash | `PARK_NO_TRUTHFUL_AUTHORITY_ROOT` |
| RABA-T0-A04 | requested delta binds subject, parent authority, action/resource, scope, budget and decision | `PARK_NO_TRUTHFUL_AUTHORITY_ROOT` |
| RABA-T0-A05 | verifier semantics cover authenticity, omission, mismatch, expiry/sequence, replay and forgery | `PARK_NO_TRUTHFUL_AUTHORITY_ROOT` |
| RABA-T0-A06 | principal/task/file scope comes from a trusted source, not permission-request input | `PARK_NO_TRUTHFUL_AUTHORITY_ROOT` |
| RABA-T0-A07 | exact non-test composition and downstream action-decision path exists or its broken edge is named | `PARK_NO_TRUTHFUL_AUTHORITY_ROOT` |
| RABA-T0-A08 | one canonical owner is selected per responsibility with rejected alternatives | `RETURN_TO_EVIDENCE` |
| RABA-T0-A09 | current and proposed locators are never conflated | `RETURN_TO_EVIDENCE` |
| RABA-T0-A10 | any proposed future manifest equals the proposed matrix path union | `RETURN_TO_EVIDENCE` |
| RABA-T0-A11 | accepted AR021 evidence is reused without broad duplicate review unless contradicted | `RETURN_TO_EVIDENCE` |
| RABA-T0-A12 | assessment and return use one exact terminal RABA-T0 decision | `RETURN_TO_EVIDENCE` |
| RABA-T0-A13 | roadmap/review/rejected-evidence hashes remain invariant and no forbidden path changes | `BLOCKED_WITH_REASON` |
| RABA-T0-A14 | pre-implementation, worker-return fast gate, diff hygiene and no-commit evidence pass | `BLOCKED_WITH_REASON` |
...
`COMPLETE_PENDING_REVIEW` token nor a passing checker closes RABA-T0. Only a
...
workerReturnPath: `docs/reviews/CVF_WP_ARCH_003_RABA_T0_ROOT_AUTHORITY_SOURCE_VERIFICATION_WORKER_RETURN_2026-09-08.md`
...
git diff --cached --name-only
git status --short --untracked-files=all
Get-FileHash 'docs/assessments/CVF_WP_ARCH_003_RABA_T0_ROOT_AUTHORITY_SOURCE_VERIFICATION_2026-09-08.md' -Algorithm SHA256
Get-FileHash 'docs/reviews/CVF_WP_ARCH_003_RABA_T0_ROOT_AUTHORITY_SOURCE_VERIFICATION_WORKER_RETURN_2026-09-08.md' -Algorithm SHA256
```
...
|---|---|---|
| `dispatchBaseHead` | orchestrator | committed packet-authoring base `dbf0f1bcc77286fe3429bf582d46df7d1f9edbd2` |
...
| phase | fresh RABA-T0 source verification and pending return |
| baseHeadFor(phase) | dispatchBaseHead=`dbf0f1bcc77286fe3429bf582d46df7d1f9edbd2`; executionBaseHead=`WORKER_MUST_CAPTURE_AT_START`; closureBaseHead=`REVIEWER_TO_SET` |
...
| Field | Value |
|---|---|
| completionReviewPath | `docs/reviews/CVF_WP_ARCH_003_RABA_T0_ROOT_AUTHORITY_SOURCE_VERIFICATION_COMPLETION_2026-09-08.md` |
...
|---|---|---|---|---|---|
| RABA parent and six questions | `docs/roadmaps/CVF_WP_ARCH_003_ROOT_AUTHORITY_AND_PRINCIPAL_SCOPE_ARCHITECTURE_REASSESSMENT_ROADMAP_2026-09-08.md` | Root Questions and Target Trust Chain | `RABA-Q01` | `WP-ARCH-003-RABA` | ACCEPT |
| terminal root-defect authority | `docs/reviews/CVF_WP_ARCH_003_AR1_R1_CANONICAL_OWNER_RUNTIME_PATH_DESIGN_REWORK_COMPLETION_2026-09-08.md` | Decision / Disposition and Risk / Corrective Action | `WP-ARCH-003-AR1-R1` | `WP-ARCH-003-AR1-R1 completion review` | ACCEPT |
...
| batch token | exact search command `rg -n "WP-ARCH-003-RABA-T0-ROOT-AUTHORITY-SOURCE-VERIFICATION" docs CVF_SESSION` produced no match before authoring | PASS_NO_COLLISION |
| search roots | worker must search the named `EXTENSIONS` source cluster plus related tests, `docs`, JSON registries and operator-supplied external evidence only | BOUNDED_REQUIRED |
...
priorVerificationArtifact: `docs/reviews/CVF_WP_ARCH_003_AR1_R1_CANONICAL_OWNER_RUNTIME_PATH_DESIGN_REWORK_COMPLETION_2026-09-08.md`

priorVerificationAnchor: `8ab5a361cbacacbc5f9c1d9e78590342a1173a23` and SHA-256 `6dbcc7b4fad60c2cee2184322e8ebd053ae76db9288b05ad50389667c5e1bd40`
...
Resolver query: taskClass=`root authority source verification`,
...
| Chain map route | committed RABA-T0 packet -> explicit operator relay -> exact-two pending evidence -> independent reviewer disposition |
...
- Corpus verdict: NOT_APPLICABLE_WITH_REASON - the task makes no complete scan,
  ...
  bounded searches prove only the RABA-T0 decision.
...
| Session or invocation | WP-ARCH-003 RABA-T0 dispatch authoring, 2026-09-08 |
| Working directory | repository root at `dbf0f1bcc77286fe3429bf582d46df7d1f9edbd2` |
| Command or tool surface | governed reads, Git, SHA-256, bounded `rg`, path checks, ADIF resolver, scaffold stdout and `apply_patch` |
| Target paths | paired RABA-T0 baseline and this work order |
| Allowed scope source | committed RABA roadmap plus operator continuation instruction on 2026-09-08 |
| Before status evidence | clean worktree for dispatch-owned material paths at the base; two rejected AR1 outputs isolated byte-exact outside this material changed set; staging empty |
| After status evidence | two new dispatch documents awaiting orchestrator validation/commit; no worker invocation or external effect |
...
| Invocation ID | `wp-arch-003-raba-t0-dispatch-authoring-2026-09-08` |
