...
| GC-018 status | `docs/baselines/CVF_GC018_ADIF_T1_ENTRY_SCHEMA_SOURCE_LAYOUT_SEED_DICTIONARY_2026-06-23.md` | `Status: CLOSED_PASS_BOUNDED` | PASS |
...
|---|---|---|
| eight seed entries | committed and integrity-checked | PASS |
