...
| Completion or reviewer artifact | T2 completion review and R2 worker return | partial terminal token independently adjudicated | PASS |
...
| Port/identity contract | additive implementation and tests pass | PASS |
