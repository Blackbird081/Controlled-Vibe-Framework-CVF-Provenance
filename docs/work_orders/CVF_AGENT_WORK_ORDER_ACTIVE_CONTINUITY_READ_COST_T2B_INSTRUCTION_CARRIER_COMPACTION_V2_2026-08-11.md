# CVF Agent Work Order V2 - Active Continuity T2B Instruction Carrier Compaction
...
Dispatch base head: `16334484937d27b83f3802d0a9f5de3cbb6a98a7`
...
executionBaseHead: worker captures current clean HEAD before edits and confirms
the `AGENTS.md` raw-filesystem SHA-256 remains `605b32534c7898117f0cbfd7747253243c342cf1619df02e96a4691507573855`.
...
4. The source/binding matrix accounts for all current AGENTS headings and
   carrier readers before rewrite, and its `AGENTS.md` preimage was revalidated
   at `16334484937d27b83f3802d0a9f5de3cbb6a98a7` after the V59 rotation.
...
manifest, and pre-implementation autorun PASS before material edits. The
tracked worker-return path is the accepted prior `BLOCKED` evidence and is the
only permitted pre-existing output; replace it in place with the new execution
return.

## Dispatcher Re-Dispatch Resolution

The prior `BLOCKED` return is accepted. For this re-dispatch, archive the raw
current worktree bytes of `AGENTS.md`; their required SHA-256 is
`605b32534c7898117f0cbfd7747253243c342cf1619df02e96a4691507573855`.
Preserve the active V59 handoff pointer. Do not use the pre-rotation CRLF hash
or a normalized Git blob hash as the archive preimage.

## Commit Stack Debt Disposition

`LEGACY_PUSH_DEBT_PRESENT`: `main` is 59 commits ahead of `origin/main` before
this correction commit. This bounded material commit and its one continuity
sync are required to finish the same operator-approved T2B tranche and cannot
be left uncommitted because the worker requires a clean execution base. No push,
public-sync, squash, rebase, or new tranche is authorized by this disposition.
...
| T2B source map | `docs/reviews/CVF_ACTIVE_CONTINUITY_READ_COST_T2B_SOURCE_BINDING_MATRIX_V2_2026-08-11.md` | SOURCE_MAP_ACCEPTED_FOR_DISPATCH |
...
| all current headings/readers are mapped | `docs/reviews/CVF_ACTIVE_CONTINUITY_READ_COST_T2B_SOURCE_BINDING_MATRIX_V2_2026-08-11.md` | heading and reader matrices | `AGENTS Heading Binding Matrix`; `Machine Reader Matrix` | accepted source map | ACCEPT |
| current carrier hashes/sizes | `docs/reviews/CVF_ACTIVE_CONTINUITY_READ_COST_T2B_SOURCE_BINDING_MATRIX_V2_2026-08-11.md` | Current Source Facts | three source paths | accepted source map | ACCEPT |
...
|---|---|
| AGENTS | `605b32534c7898117f0cbfd7747253243c342cf1619df02e96a4691507573855` |
...
Retain the exact active V59 pointer. Do not duplicate historical narrative.
...
| baseHeadFor(phase) | `dispatchBaseHead=16334484937d27b83f3802d0a9f5de3cbb6a98a7`; worker captures executionBaseHead; reviewer captures closureBaseHead |
...
| dispatchBaseHead | `16334484937d27b83f3802d0a9f5de3cbb6a98a7` |
...
The routing-index, checker, test, and archive outputs must remain absent before
the worker writes them. The worker-return path now exists as the accepted prior
`BLOCKED` evidence committed by the orchestrator/reviewer; it is an authorized
collision exception and must be replaced in place. The worker must repeat all
other collision checks and all three exact preimage-hash checks before writing.
...
| Session or invocation | ACRC-T2B source correction and re-dispatch, 2026-08-11 |
| Working directory | repository root at `16334484937d27b83f3802d0a9f5de3cbb6a98a7` |
| Command or tool surface | progressive reads, raw worktree SHA-256, Git blob and line-ending diagnostics, governed patch authoring |
| Target paths | source/binding matrix; this Work Order; prior blocked worker return |
| Allowed scope source | explicit operator T2B selection, accepted roadmap, and operator-delegated orchestrator/reviewer authority on 2026-08-11 |
| Before status evidence | clean worktree at HEAD `16334484937d27b83f3802d0a9f5de3cbb6a98a7` before the prior worker authored its return; staged zero; the accepted blocked return was the only untracked re-dispatch input |
| After status evidence | exact three-path re-dispatch material packet before commit |
| Diff evidence | source revalidation, exact status/name-status, pre-dispatch autorun, and dispatch commit-steward evidence |
| Approval boundary | corrected exact-15 no-commit re-dispatch only |
...
| Invocation ID | `active-continuity-read-cost-t2b-redispatch-2026-08-11` |
| Expected manifest | `docs/reviews/CVF_ACTIVE_CONTINUITY_READ_COST_T2B_SOURCE_BINDING_MATRIX_V2_2026-08-11.md`; `docs/work_orders/CVF_AGENT_WORK_ORDER_ACTIVE_CONTINUITY_READ_COST_T2B_INSTRUCTION_CARRIER_COMPACTION_V2_2026-08-11.md`; `docs/reviews/CVF_ACTIVE_CONTINUITY_READ_COST_T2B_WORKER_RETURN_2026-08-11.md` |
| Actual changed set | `docs/reviews/CVF_ACTIVE_CONTINUITY_READ_COST_T2B_SOURCE_BINDING_MATRIX_V2_2026-08-11.md`; `docs/work_orders/CVF_AGENT_WORK_ORDER_ACTIVE_CONTINUITY_READ_COST_T2B_INSTRUCTION_CARRIER_COMPACTION_V2_2026-08-11.md`; `docs/reviews/CVF_ACTIVE_CONTINUITY_READ_COST_T2B_WORKER_RETURN_2026-08-11.md` |
