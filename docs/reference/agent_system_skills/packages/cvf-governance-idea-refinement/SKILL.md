...
| Field | Value |
|---|---|
| Allowed task classes | ideation, operator-interview, roadmap-selection |
| Allowed roles | dispatcher, worker, reviewer |
| Allowed phases | INTAKE, DISPATCH_AUTHORING, WORKER_EXECUTION, REVIEWER_CLOSURE |
| Allowed surfaces | docs/reference/agent_system_skills/packages/cvf-governance-idea-refinement/, registry entries, truth packets, review artifacts |
| Risk ceiling | R0 |
...
| Trigger patterns | refine idea, brainstorm, unclear concept, options, shape request |
...
| Invocation ID | `ascp-p4-p6-package-cvf-governance-idea-refinement-2026-06-30` |
