...
| Field | Value |
|---|---|
| Allowed task classes | release-readiness, launch-planning, closure-review |
| Allowed roles | dispatcher, worker, reviewer |
| Allowed phases | INTAKE, DISPATCH_AUTHORING, WORKER_EXECUTION, REVIEWER_CLOSURE |
| Allowed surfaces | docs/reference/agent_system_skills/packages/cvf-engineering-shipping-launch/, registry entries, truth packets, review artifacts |
| Risk ceiling | R1 |
...
| Trigger patterns | shipping, launch, release readiness, rollback plan, staged rollout |
...
| Invocation ID | `ascp-p4-p6-package-cvf-engineering-shipping-launch-2026-06-30` |
