# CVF ASSF Package: Engineering Shipping And Launch Front Door
...
Provide the stable front door for the `cvf-engineering-shipping-launch` ASSF package proposal.
