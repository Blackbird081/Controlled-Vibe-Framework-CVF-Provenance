...
| Risk ceiling | R1 |
| Authority ceiling | metadata-only advisory; loading never authorizes commit, merge, runtime, or external actions |
...
| Outputs | proposed package-body guidance (awaiting reviewer acceptance); five-axis review framework notes; severity classification discipline; recommended CVF owner-surface routing |
...
| Safe stop | stop and open a fresh ASSF runtime tranche if automated merge execution, production change authority, or authority above the active work order is needed |
...
| Post-reviewer-acceptance (APPROVED) | full five-axis review guidance; requires reviewer decision gate |
...
This package root is a PROPOSED CVF adaptation sourced from the upstream `code-review-and-quality` skill at pinned commit `aba7c4e9695c363e65cb59effe926c7f1d1abe3d`. It does not execute code reviews autonomously, trigger merges, implement a CLI/MCP adapter, or claim automatic invocation.
