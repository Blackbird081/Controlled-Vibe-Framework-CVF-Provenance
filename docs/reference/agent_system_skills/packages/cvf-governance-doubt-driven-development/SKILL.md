...
Guide adversarial fresh-context review of non-trivial decisions to reduce hallucination, rationalization, and shallow PASS closeout.

Use when a governed CVF task matches the `doubt-driven-development` package pattern after explicit package selection and receipt-backed production execution. Do not use as autonomous runtime authority, provider routing authority, public-sync proof, merge approval, commit permission, or permission to bypass active CVF work-order gates.
...
| Field | Value |
|---|---|
| Allowed task classes | reviewer-challenge, risk-review, epistemic-check |
| Allowed roles | dispatcher, worker, reviewer |
| Allowed phases | INTAKE, DISPATCH_AUTHORING, WORKER_EXECUTION, REVIEWER_CLOSURE |
| Allowed surfaces | docs/reference/agent_system_skills/packages/cvf-governance-doubt-driven-development/, registry entries, truth packets, review artifacts |
| Risk ceiling | R0 |
...
| Trigger patterns | doubt-driven, fresh-context review, adversarial review, high stakes decision, verify assumptions |
...
| Invocation ID | `ascp-p4-p6-package-cvf-governance-doubt-driven-development-2026-06-30` |
