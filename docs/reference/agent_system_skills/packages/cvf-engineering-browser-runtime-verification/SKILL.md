...
| Field | Value |
|---|---|
| Allowed task classes | browser-runtime-review, frontend-verification, ui-debugging |
| Allowed roles | dispatcher, worker, reviewer |
| Allowed phases | INTAKE, DISPATCH_AUTHORING, WORKER_EXECUTION, REVIEWER_CLOSURE |
| Allowed surfaces | docs/reference/agent_system_skills/packages/cvf-engineering-browser-runtime-verification/, registry entries, truth packets, review artifacts |
| Risk ceiling | R1 |
...
| Trigger patterns | browser test, devtools verification, dom inspection, console errors, visual verification |
...
| Invocation ID | `ascp-p4-p6-package-cvf-engineering-browser-runtime-verification-2026-06-30` |
