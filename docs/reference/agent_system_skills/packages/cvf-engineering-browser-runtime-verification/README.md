# CVF ASSF Package: Engineering Browser Runtime Verification Front Door
...
Provide the stable front door for the `cvf-engineering-browser-runtime-verification` ASSF package.
