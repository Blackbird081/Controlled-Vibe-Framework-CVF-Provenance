# CVF ASSF Package: Governance Skill Discovery And Invocation Front Door
...
Provide the stable front door for the `cvf-governance-skill-discovery-invocation` ASSF package proposal.
