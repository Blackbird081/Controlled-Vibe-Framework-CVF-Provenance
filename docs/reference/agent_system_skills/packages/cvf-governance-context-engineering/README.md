# CVF ASSF Package: Governance Context Engineering Front Door
...
Provide the stable front door for the `cvf-governance-context-engineering` ASSF package proposal.
