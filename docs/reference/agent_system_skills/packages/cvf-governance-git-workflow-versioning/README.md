# CVF ASSF Package: Governance Git Workflow And Versioning Front Door
...
Provide the stable front door for the `cvf-governance-git-workflow-versioning` ASSF package.
