# CVF ASSF Package: Governance Documentation And ADRs Front Door
...
Provide the stable front door for the `cvf-governance-documentation-adrs` ASSF package proposal.
