# CVF ASSF Package: Engineering Source-Driven Development Front Door
...
Provide the stable front door for the `cvf-engineering-source-driven-development` ASSF package proposal.
