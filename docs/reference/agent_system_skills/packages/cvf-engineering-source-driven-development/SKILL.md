...
Guide official-documentation-backed implementation decisions for framework or library work where current source correctness matters.

Use when a governed CVF task matches the `source-driven-development` package pattern after explicit package selection and receipt-backed production execution. Do not use as autonomous runtime authority, provider routing authority, public-sync proof, merge approval, commit permission, or permission to bypass active CVF work-order gates.
...
| Field | Value |
|---|---|
| Allowed task classes | source-verification, implementation-planning, technical-research |
| Allowed roles | dispatcher, worker, reviewer |
| Allowed phases | INTAKE, DISPATCH_AUTHORING, WORKER_EXECUTION, REVIEWER_CLOSURE |
| Allowed surfaces | docs/reference/agent_system_skills/packages/cvf-engineering-source-driven-development/, registry entries, truth packets, review artifacts |
| Risk ceiling | R0 |
...
| Trigger patterns | source driven development, official docs, current best practices, framework docs, verify docs |
...
| Invocation ID | `ascp-p4-p6-package-cvf-engineering-source-driven-development-2026-06-30` |
