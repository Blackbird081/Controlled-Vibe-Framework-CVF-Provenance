# CVF ASSF Package: Engineering Deprecation And Migration Front Door
...
Provide the stable front door for the `cvf-engineering-deprecation-migration` ASSF package proposal.
