# CVF ASSF Package: Engineering API And Interface Design Front Door
...
Provide the stable front door for the `cvf-engineering-api-interface-design` ASSF package proposal.
