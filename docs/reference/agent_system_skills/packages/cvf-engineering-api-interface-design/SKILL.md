...
| Allowed surfaces | docs/reference/agent_system_skills/packages/cvf-engineering-api-interface-design/, registry entries, truth packets, review artifacts |
| Risk ceiling | R1 |
...
| Trigger patterns | api design, interface boundary, module contract, component props, schema contract |
...
| Invocation ID | `ascp-p4-p6-package-cvf-engineering-api-interface-design-2026-06-30` |
