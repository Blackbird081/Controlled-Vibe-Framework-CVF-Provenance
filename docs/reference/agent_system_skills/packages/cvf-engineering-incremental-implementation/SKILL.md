...
| Field | Value |
|---|---|
| Allowed task classes | implementation-planning, worker-execution, scope-control |
| Allowed roles | dispatcher, worker, reviewer |
| Allowed phases | INTAKE, DISPATCH_AUTHORING, WORKER_EXECUTION, REVIEWER_CLOSURE |
| Allowed surfaces | docs/reference/agent_system_skills/packages/cvf-engineering-incremental-implementation/, registry entries, truth packets, review artifacts |
| Risk ceiling | R1 |
...
| Trigger patterns | incremental implementation, small slices, large task, multi-file change, stepwise delivery |
...
| Invocation ID | `ascp-p4-p6-package-cvf-engineering-incremental-implementation-2026-06-30` |
