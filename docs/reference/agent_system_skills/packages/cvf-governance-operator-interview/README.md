# CVF ASSF Package: Governance Operator Interview Front Door
...
Provide the stable front door for the `cvf-governance-operator-interview` ASSF package proposal.
