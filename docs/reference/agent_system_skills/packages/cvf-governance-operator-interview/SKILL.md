...
| Field | Value |
|---|---|
| Allowed task classes | operator-clarification, requirements-discovery, scope-definition |
| Allowed roles | dispatcher, worker, reviewer |
| Allowed phases | INTAKE, DISPATCH_AUTHORING, WORKER_EXECUTION, REVIEWER_CLOSURE |
| Allowed surfaces | docs/reference/agent_system_skills/packages/cvf-governance-operator-interview/, registry entries, truth packets, review artifacts |
| Risk ceiling | R0 |
...
| Trigger patterns | interview me, clarify request, underspecified task, what do you want, requirements interview |
...
| Invocation ID | `ascp-p4-p6-package-cvf-governance-operator-interview-2026-06-30` |
