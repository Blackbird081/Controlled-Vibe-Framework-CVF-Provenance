# CVF ASSF Package: Engineering CI/CD Quality Gates Front Door
...
Provide the stable front door for the `cvf-engineering-ci-cd-quality-gates` ASSF package proposal.
