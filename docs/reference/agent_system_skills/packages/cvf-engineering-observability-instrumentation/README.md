# CVF ASSF Package: Engineering Observability And Instrumentation Front Door
...
Provide the stable front door for the `cvf-engineering-observability-instrumentation` ASSF package proposal.
