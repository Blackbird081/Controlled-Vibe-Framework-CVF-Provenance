...
- Reconciliation: manifest=11 source artifacts; ledger_terminal=25 indexed candidate rows plus 1 terminal source-family closure; exclusions=0; unresolved=0
- Unresolved files: 0
- Declared exclusions: none
- Unreadable or unsupported files: none
- Aggregation check: 25 indexed candidate rows and 1 terminal source-family closure are sourced from 11 governed artifacts listed below.
