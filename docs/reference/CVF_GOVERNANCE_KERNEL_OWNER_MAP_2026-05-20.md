...
| Memory tier model | memory tier classifier contract | `canonical_owner` | Owns the tier classifier contract for the frozen memory tier model. | `EXTENSIONS/CVF_LEARNING_PLANE_FOUNDATION/src/memory-tier-classifier.contract.ts` |
