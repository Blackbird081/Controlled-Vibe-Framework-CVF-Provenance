...
| OpenAI | `gpt-4o-mini` | `CERTIFIED` | [20260509-141626-fa4465](../audits/openai-canary/CVF_RECEIPT_20260509-141626-fa4465.md) | 3 consecutive PASS 6/6 | Operator-paid OpenAI billing; certified lane is `gpt-4o-mini`, not every OpenAI model. |
