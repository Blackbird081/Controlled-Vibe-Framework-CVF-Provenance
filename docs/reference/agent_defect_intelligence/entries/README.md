...
| `CVF_ADIF-0042.md` | ADIF-0042 | CLOSURE_EVIDENCE | GUIDANCE_ONLY |
| `CVF_ADIF-0043.md` | ADIF-0043 | SOURCE_FIDELITY | GUIDANCE_ONLY |
...
| `CVF_ADIF-0051.md` | ADIF-0051 | SCOPE_AND_OWNERSHIP | PARTIAL_CHECK |
...
| `CVF_ADIF-0056.md` | ADIF-0056 | GATE_TRIGGER_FRICTION | GUIDANCE_ONLY |
| `CVF_ADIF-0057.md` | ADIF-0057 | SCOPE_AND_OWNERSHIP | PARTIAL_CHECK |
