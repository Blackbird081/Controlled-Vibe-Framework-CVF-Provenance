...
Status: T1_COMPLETE_T2_REVIEWED_T3_CLOSED_PASS_BOUNDED_T4_CLOSED_PASS_BOUNDED_T5_DISPATCH_READY
...
| CI1-T5 | Classification Sampling Protocol | adversarial sampling protocol over the T4 model with accepted/deferred/rejected/zero-result rows | DISPATCH_READY |
