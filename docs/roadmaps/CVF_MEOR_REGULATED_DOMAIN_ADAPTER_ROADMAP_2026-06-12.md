...
Status: ACTIVE_RDA_T1_DISPATCHED
...
| --- | --- | --- | --- |
| RDA-T1 | Regulated-date adapter contract and machine semantics | MEOR-T5 closure `6c2ad2b3` | DISPATCHED |
| RDA-T2 | Local deterministic adapter implementation for regulated profile requirement generation | RDA-T1 closure | HOLD_UNTIL_T1_PASS |
