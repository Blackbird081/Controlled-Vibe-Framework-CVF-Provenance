...
| MEOR-T2 | Extraction-foundation implementation that normalizes metadata findings and feeds the existing EX-T9 report surface | MEOR-T1 completion at `22818605` plus sync `662e3c76` | DISPATCH_READY |
