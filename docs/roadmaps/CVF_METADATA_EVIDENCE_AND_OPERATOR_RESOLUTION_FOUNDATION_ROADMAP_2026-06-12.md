...
Status: ACTIVE_FOUNDATION_FIRST_T4_SPEC_PENDING
...
| MEOR-T4 | Cross-domain conformance suite using legal-policy and technical-project synthetic fixtures | MEOR-T3 material `0c4997a5` plus closure commit | SPEC_PENDING |
