...
Status: T0_PASS_BOUNDED_T1_DISPATCH_READY_T2_HELD
...
|---|---|---|---|
| Baseline status | T1 baseline | `Status: DISPATCH_READY` | PASS |
| Work order status | T1 work order | `Status: DISPATCH_READY` | PASS |
| Completion or reviewer artifact | T0 completion review | `Status: REVIEWER_ACCEPTED_BOUNDED` | PASS |
| Worker return | future T1 worker return | worker-owned | N/A with reason |
| Roadmap state | this roadmap | `Status: T0_PASS_BOUNDED_T1_DISPATCH_READY_T2_HELD` | PASS |
...
| T1 mutation boundary | dry-run receipt output only; zero target mutation | dispatch contract | PASS |
| next tranche release | T1 execution only; T2 held | `T0_PASS_BOUNDED_T1_DISPATCH_READY_T2_HELD` | PASS |
