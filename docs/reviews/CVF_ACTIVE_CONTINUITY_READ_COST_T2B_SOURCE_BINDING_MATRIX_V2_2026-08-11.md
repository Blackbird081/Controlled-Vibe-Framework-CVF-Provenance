# CVF Active Continuity Read Cost T2B Source Binding Matrix V2
...
Source base head: `16334484937d27b83f3802d0a9f5de3cbb6a98a7`
...
|---|---:|---:|---|
| `AGENTS.md` | 1119 | 53603 | `605b32534c7898117f0cbfd7747253243c342cf1619df02e96a4691507573855` |
...
## Re-Dispatch Source Revalidation

The `AGENTS.md` row was recomputed from the raw filesystem bytes at clean HEAD
`16334484937d27b83f3802d0a9f5de3cbb6a98a7` after the authorized V58-to-V59
active-handoff-pointer rotation. The authoritative archive preimage is the
current worktree byte stream with SHA-256 `605b32534c7898117f0cbfd7747253243c342cf1619df02e96a4691507573855`.
The Git blob LF hash is not the archive hash because the Work Order requires a
raw byte copy of the current carrier before rewrite.
...
| Session or invocation | ACRC-T2B source revalidation and re-dispatch, 2026-08-11 |
| Working directory | repository root at `16334484937d27b83f3802d0a9f5de3cbb6a98a7` |
| Command or tool surface | progressive reads, raw filesystem SHA-256, Git blob comparison, line-ending diagnostics, source-map and dispatch correction |
| Target paths | this source map; paired Work Order; prior blocked worker return |
| Allowed scope source | operator T2B selection, active-continuity roadmap, and explicit orchestrator/reviewer authority on 2026-08-11 |
| Before status evidence | HEAD `16334484937d27b83f3802d0a9f5de3cbb6a98a7`; staged zero; prior blocked worker return was the only untracked path |
| After status evidence | exact three-path re-dispatch material packet before commit |
| Diff evidence | raw worktree hash `605b3253...`, normalized Git blob hash comparison, V58-to-V59 diff, exact status/name-status, and pre-dispatch gates |
| Approval boundary | source revalidation, blocker evidence preservation, and exact-15 re-dispatch only |
| Claim boundary | no carrier rewrite, downstream mutation, external call, commit, or push |
| Agent type | source mapper/reviewer |
| Invocation ID | `active-continuity-read-cost-t2b-source-revalidation-2026-08-11` |
