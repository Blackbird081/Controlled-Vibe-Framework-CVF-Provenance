...
# CVF W134 Runtime Stability — DeepSeek Confirmatory

**Run status:** complete
**Captured:** 2026-05-07T09:39:41.843Z
**Provider:** deepseek / deepseek-chat
**Session isolation:** per_journey_browser_context
**Inter-journey delay:** 1500ms (Fix-C)
**Tranche:** W134-T1 CP5 — DeepSeek Confirmatory Run
...
|---|---|---|---|---|---|---|---|---|
| 1 | documentation | `accepted_with_exports` | — | 200 | 33573ms | ✅ | ✅ | ✅ |
| 2 | email_template | `accepted_with_exports` | — | 200 | 20286ms | ✅ | ✅ | ✅ |
| 3 | risk_assessment | `accepted_with_exports` | — | 200 | 46830ms | ✅ | ✅ | ✅ |
| 4 | competitor_review | `accepted_with_exports` | — | 200 | 30041ms | ✅ | ✅ | ✅ |
| 5 | user_persona | `accepted_with_exports` | — | 200 | 40560ms | ✅ | ✅ | ✅ |
| 6 | strategy_analysis | `accepted_with_exports` | — | 200 | 40747ms | ✅ | ✅ | ✅ |
