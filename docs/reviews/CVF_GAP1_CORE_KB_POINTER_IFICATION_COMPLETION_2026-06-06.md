...
|---|---|---|---|
| GAP1 Core KB maintainability | Pointer-ify duplicated sections III-X, XIII, XV-XIX | Core KB reduced to 400 lines | CLOSED_PASS_BOUNDED |
...
| Line-count target | `(Get-Content docs/CVF_CORE_KNOWLEDGE_BASE.md | Measure-Object -Line).Lines` -> `400` | PASS |
