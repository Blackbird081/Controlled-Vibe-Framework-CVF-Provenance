...
Current HEAD recorded for this handoff: `91ed6188` (parent: `66267e8e`). Session updated 2026-06-02 for orchestrator dispatch-learning standardization after adding work-order wording hygiene and scan-to-learning routing rules.
