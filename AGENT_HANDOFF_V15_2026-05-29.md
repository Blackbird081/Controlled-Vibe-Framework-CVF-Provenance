...
Current mode: `se1_is1_simulation_env_generic_adapter_closed_pass_bounded`.
...
Startup acknowledged: current mode=`se1_is1_simulation_env_generic_adapter_closed_pass_bounded`;
