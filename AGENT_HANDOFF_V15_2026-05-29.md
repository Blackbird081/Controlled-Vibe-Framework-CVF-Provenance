...
Current mode: `lplp1_learning_plane_live_proof_closed_pass_bounded`.
...
Startup acknowledged: current mode=`lplp1_learning_plane_live_proof_closed_pass_bounded`;
