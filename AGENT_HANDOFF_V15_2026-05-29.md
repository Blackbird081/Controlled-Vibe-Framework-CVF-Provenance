...
Current mode: `rm1_reputation_routing_advisory_closed_pass_bounded`.
...
Startup acknowledged: current mode=`rm1_reputation_routing_advisory_closed_pass_bounded`;
