...
- **Latest release-gate verification (2026-05-08, post-W149):** `python scripts/run_cvf_release_gate_bundle.py --json` PASS. Result: Web build PASS, TypeScript check PASS, provider readiness PASS, secrets scan PASS, docs governance PASS, UI mock Playwright PASS, live governance Playwright PASS. 7/7 checks PASS.
