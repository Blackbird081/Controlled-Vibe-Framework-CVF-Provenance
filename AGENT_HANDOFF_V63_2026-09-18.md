...
Current material HEAD: `3ce236479`. Group 1 is `SOURCE_CREATED_LOCAL_VERIFIED`; Group 2 v1 is `ACTIVATED_LOCAL_VERIFIED_PENDING_CONSUMER_BINDING`.
...
Party C is Local verified. T3D-C1 tooling remains `TOOLING_ACCEPTED_SOURCE_NOT_CREATED`; T3D-C0-R1 contract-only operational-boundary repair remains dispatched, and its machine-recognized authority/probe/review-cost plus worker-return binding is corrected through `3ce236479`. Real Group 4 source creation and T3E remain closed.
