...
Current mode marker: `external_local_absorption_contract_hardening`
Current mode: `external_local_absorption_contract_hardening`; previous mode marker: `domain_pilot_initial_intake_closed`
