...
Current mode marker: `gclh_mfrp_p3_r1_design_review_checkpoint_required`
Current mode: `gclh_mfrp_p3_r1_design_review_checkpoint_required`; previous mode marker: `gclh_mfrp_p3_dispatch_ready_worker_execution_checkpoint_required`
Previous mode: `gclh_mfrp_p3_dispatch_ready_worker_execution_checkpoint_required`

## Next Allowed Move

Mode: `gclh_mfrp_p3_r1_design_review_checkpoint_required`. Original P3 is rejected `RETURN_TO_DESIGN`; its five returned artifacts are byte-preserved only in `docs/reviews/rejected_evidence/MFRP_P3_2026-09-01/` with `.rejected` suffixes at material commit `0cb164a1d6b27fef21cf829d32465923d1331c49`. Next allowed move is independent critique of the committed P3-R1 actual-seam/committed-oracle redesign. R1A/R1B implementation requires critique reconciliation, explicit operator approval and a fresh source-verified baseline/work order. P4-P6, lifecycle activation, downstream, GC010 and external effects remain parked. Latest finalized numbered LHW wave remains LHW24.
