...
Current mode marker: `rspb_ai_t2_snapshot_doctor_enrichment_dispatched_pending_worker`
Current mode: `rspb_ai_t2_snapshot_doctor_enrichment_dispatched_pending_worker`
Previous mode: `rspb_ai_t1_snapshot_value_probe_closed_proceed_checkpoint_required`

## Next Allowed Move

Mode: `rspb_ai_t2_snapshot_doctor_enrichment_dispatched_pending_worker`
...
RSPB-AI-T1 is independently accepted bounded at `d591c542a`. RSPB-AI-T2 is dispatched at `0af246b4f` with a four-output `WORKER_MUST_NOT_COMMIT` manifest: doctor snapshot owner, release-bundle consumer, isolated test, and worker return. Execute that packet next; direct candidate implementation use, acquisition/mutation, secrets/raw paths, network/provider/live, push, public sync, deployment, production, staging, and worker commit remain parked.
