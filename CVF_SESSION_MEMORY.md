...
is authorized until the matching fresh work order exists and passes gates.
Runtime smoke remains held until cache/config readiness is accepted under a
later fresh authority.
