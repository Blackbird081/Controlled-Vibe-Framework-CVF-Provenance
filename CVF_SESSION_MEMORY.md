...
Startup acknowledged: current mode=`cvf_web_inheritance_t4_dispatched_worker_next`; active handoff=AGENT_HANDOFF_V47_2026-07-18.md; next allowed move=execute only committed CVF-WEB-INHERITANCE-T4 decision packet; parked checkpoint=T4 implementation, T5, provider/live, public-sync, push, production, and external mutation lanes.

## Current Mode

Current mode marker: `cvf_web_inheritance_t4_dispatched_worker_next`
...
Mode: `cvf_web_inheritance_t4_dispatched_worker_next`
