...
Mode: `gclh_mfrp_p4_c1_automatic_evidence_collection_active`. Accepted P4 material is `b9bdba712`; eligible count remains 0 and the M5/M10/safety/M20 rules are unchanged. DARA-T2B is `CLOSED_PASS_BOUNDED`. DARA-T3 initial replay was rejected at `537dad6ce752f75d6dc2e36e272639758e7ca829`; the final admitted R1 external return is independently rejected `RETURN_TO_DESIGN` at `c9e3c88e0355491cd2e6bfffda3c04249352a553`. Parent external usage is 2 of ceiling 2, the exact-five worker material remains uncommitted, and no automatic third invocation is authorized. DARA-T3 now requires an operator checkpoint for any fresh reopen authority; otherwise preserve the rejected evidence and keep DARA-T4 parked. Substantive `WP-ARCH-003` repair, provider/live/public/deploy and other parked lanes remain closed. In the independent System Chain lane, CSCC-R1-T2A remains stopped at `c1f95ae1d`. Latest finalized numbered LHW wave remains LHW24.
