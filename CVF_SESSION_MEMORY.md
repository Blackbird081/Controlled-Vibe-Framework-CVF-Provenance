...
Current mode marker: `external_local_absorption_pilot_pattern_relay`
Current mode: `external_local_absorption_pilot_pattern_relay`; previous mode marker: `domain_pilot_initial_intake_closed`
