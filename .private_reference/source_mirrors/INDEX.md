...
| `yc-software__qm` | `https://github.com/yc-software/qm.git` | `.private_reference/source_mirrors/yc-software__qm/` | `59cf6554faadcd06494782190c3ecae1829dd381` (default-branch HEAD observed 2026-09-14T00:44:58.129007+00:00; prior R1/R2 pin `51bf455ea414a58f70274284ce212142518e556a` retained in history) | `CLONED_PINNED` | 2026-09-14 | 1805 | `docs/work_orders/CVF_AGENT_WORK_ORDER_QM_RUNTIME_VALUE_R3_2026-09-14.md` Upstream Freshness Preflight | R1/R2 evidence accepted; R3 ACL/policy/security audit pending worker | immutable source evidence; MIT root LICENSE unchanged; 14-path web-UI delta not semantically audited here | no upstream execution, installation, provider/live, public-sync or direct import |
