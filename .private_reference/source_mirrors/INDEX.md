...
| `yc-software__qm` | `https://github.com/yc-software/qm.git` | `.private_reference/source_mirrors/yc-software__qm/` | `51bf455ea414a58f70274284ce212142518e556a` (tag `v0.1.11`; observed 2026-09-12T06:23:05Z; work-order-recorded observation `32b38cec6effa6ec8a7cd6803c39d480e0e3d5a2` is stale and superseded by this fresh pin) | `CLONED_PINNED` | 2026-09-12 | 1805 | `docs/audits/CVF_DOMAIN_PILOT_INITIAL_INTAKE_2026-09-12.json` (this pilot's audit ledger; no prior external-agent pack exists for QM) | DOMAIN-PILOT-INITIAL-INTAKE (2026-09-12) bounded README and one skill-file reading; confirms per-scope isolated-workspace and multi-harness hypotheses as advisory `PROMISING_FOR_SELECTED_REVIEW` candidates; no absorption accepted | pinned upstream mirror is authority for QM facts; operator-supplied URL identity, MIT license read at root only, `src/` module surface enumerated by directory name and not source-verified | no dependency install, build, test, upstream execution, provider/API/account use, runtime mutation, package/checker wiring, public-sync, production claim, or direct import |
