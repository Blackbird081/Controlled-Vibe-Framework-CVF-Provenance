...
- Branch: `main`. Current HEAD recorded for this handoff: `3de7933a7d9942d29ee4997177f8f8607098d093` (`chore(handoff): sync external review input material head`). Public review input is live at public `main` commit `2aa17841892fac3cde74214ad0471814084294e0`; GitHub preflight run `33233847748` passed; `EXTERNAL_AGENT_READ` refresh receipt SHA-256 is `df0918e2b636a16525c8ecdc2a54efeabfe6ad69273cf373d058df63a1fb3c55`.
