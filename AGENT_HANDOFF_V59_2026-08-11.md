...
- Branch: `main`. Current HEAD recorded for this handoff: `878e88f08` (EARTR-ESC-R1 accepted material parent marker). Public review input is live at public `main` commit `2aa17841892fac3cde74214ad0471814084294e0`; GitHub preflight run `33233847748` passed; `EXTERNAL_AGENT_READ` refresh receipt SHA-256 is `df0918e2b636a16525c8ecdc2a54efeabfe6ad69273cf373d058df63a1fb3c55`.
- EARTR-ESC-R1 is independently accepted `CLOSED_PASS_BOUNDED` at material commit `878e88f08`: protocol 1.2 typed candidates, strict/legacy dual reading, exact receipt binding, and exact-path absorption-checker applicability; focused packet 117/117, checker 30/30, reviewer preflight PASS, pre-commit 87/87. Public/portable 1.2 projection and `EXTERNAL_AGENT_READ` refresh remain parked behind a separate operator value/authority gate; no provider/live, push, deploy, or production claim.
