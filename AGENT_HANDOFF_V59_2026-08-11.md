...
- Branch: `main`. Current HEAD recorded for this handoff: `48f4fa39aec18146d88bfa378744fde55807f034` (`docs: publish external source collaboration review input`). Updated 2026-08-29 after the bounded public review-input provenance material commit; public-sync push evidence remains to be recorded after sibling-clone verification.
