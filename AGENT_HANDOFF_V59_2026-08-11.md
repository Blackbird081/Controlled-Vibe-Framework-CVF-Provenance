...
- Branch: `main`. Current HEAD recorded for this handoff: `001e598a9` (EARTR 1.2 fresh-chat portability bounded repair). Public protocol 1.2 is live at public `main` commit `a64bbc83756d8e30a917f97510866795df491130`; PR `#6` required checks passed; `EXTERNAL_AGENT_READ` refresh receipt SHA-256 is `40ccdbb33090e42008f3210307190849d4945c25a0220d667bf1dd79563f44c6`.
