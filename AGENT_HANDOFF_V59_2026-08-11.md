...
- MFRP-P3 original replay is rejected; R1A-R1 is ratified at `7f607d353`. P4-D0 design is accepted bounded at `25aaade8b`. R1B review is `4ba2edbca`; correction is `37c3945df`; review-admission enforcement is `e7f1690659196f3cb220228b3ef5c4dfa5d3fe2c`. R1B is execution-ready; P4 stays parked.
