...
- MFRP R1A-R1 is ratified at `7f607d353`; P4-D0 design at `25aaade8b`; review-admission enforcement at `e7f169065`. R1B replay `2b06d928d` is `RETURN_TO_DESIGN` for source-binding, oracle and ledger gaps. Operator opened R1A-R2 then R1B repair; P4 stays parked pending acceptance.
