...
- Branch: `main`. Current HEAD recorded for this handoff: `6b415356c` (EARTR 1.2 public/portable release evidence). Public protocol 1.2 is live at public `main` commit `771cb3949678907d02c045e40772e008bd138245`; PR `#5` required checks passed; `EXTERNAL_AGENT_READ` refresh receipt SHA-256 is `c52433c4ce383e22df6777dc4de54f0c1e4eada4ee83dfbe6597dd34a132a540`.
- EARTR-ESC-R1 is independently accepted `CLOSED_PASS_BOUNDED` at material commit `878e88f08` and released as `cvf.external-agent-round-trip@1.2.0`: typed source-value/internal-defect lanes, strict/legacy dual reading, exact receipt binding, and exact-path checker applicability. Public/portable synchronization is complete; the next allowed use is a source-pinned External Agent audit followed by Local reconciliation and Operator decision. Candidate acceptance still grants no implementation authority; provider/live, deploy, production, and unrelated work remain outside this release.
