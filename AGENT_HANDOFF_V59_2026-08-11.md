...
- Branch: `main`. Current HEAD recorded for this handoff: `531e58336` (EARTR 1.2 producer-contract correction evidence; canonical repair `c1e34b5d1`). Public protocol 1.2 is live at public `main` commit `a64bbc83756d8e30a917f97510866795df491130`; PR `#6` required checks passed; `EXTERNAL_AGENT_READ` refresh receipt SHA-256 is `3b517f5a793322aadd5e0a47fce6fc1f39510c14f43684489d98e497348d96de`.
- EARTR-ESC-R1 is independently accepted `CLOSED_PASS_BOUNDED` and released as `cvf.external-agent-round-trip@1.2.0`. External follow-up A/I confirmed one `MEDIUM` representation-completeness gap; existing canonical/public/portable owners now expose exact strict-v1 fields, enums, forbidden fields, source joins, and valid examples with validator behavior unchanged (117/117 PASS). RB-01 receipt binding is implemented/tested, while Local reconciliation equality remains documentation/reviewer-enforced rather than a runtime gate. The next allowed use is a source-pinned External audit followed by Local reconciliation and Operator decision; candidate acceptance still grants no implementation authority.
