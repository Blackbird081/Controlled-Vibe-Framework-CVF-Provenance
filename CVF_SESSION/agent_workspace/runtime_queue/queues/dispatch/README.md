# CVF Agent Workspace Dispatch Queue Pointer
...
Mapped lane: `dispatch`

## Purpose

Identify the future dispatch queue-family location without creating runtime
queue records.

## Scope / Target / Owner Boundary

Target: dispatch queue-family pointer.
