...
Orient agents to the local `accepted_material` lane in the bounded agent
workspace skeleton.

## Scope / Target / Owner Boundary

Target: `CVF_SESSION/agent_workspace/workspace/lanes/accepted_material/`.
