...
## Mandatory Knowledge Absorption Blind-Spot Control (All Agents)

Any agent absorbing legacy/external knowledge must produce a Blind-Spot
Control Block with verdict `CLEAR`/`PARTIAL`/`BLOCKED` per:
`docs/reference/CVF_KNOWLEDGE_ABSORPTION_BLINDSPOT_PREVENTION_STANDARD_2026-05-24.md`.
Cross-agent binding (see AGENTS.md + CLAUDE.md for full text).
...
## Phase 2.B Per-Surface Migrations Archive — 2026-05-24

Ten bounded Phase 2.B per-surface migration sections dated 2026-05-20 and
2026-05-21 (all `CLOSED_PASS_BOUNDED`) were extracted from this front door on
2026-05-24 to keep the active session memory under the GC-023 hard threshold
and to demonstrate the long-term split strategy: when this file approaches
1200 lines, archive closed dated sections rather than register exceptions.

Archive: `CVF_SESSION/handoffs/archive/CVF_SESSION_MEMORY_PHASE_2B_ARCHIVE_2026-05-24.md`

Sections archived (all dated 2026-05-20 or 2026-05-21):

- Phase 2.B Receipt Critical Path Migration
- Phase 2.B Execution Bridge Receipt Chain Migration
- Phase 2.B Audit Trace Task Receipt Chains Migration
- Phase 2.B Policy Risk Chain Adapters Migration
- Phase 2.B Identity Control Plane Adapters Migration
- Phase 2.B Safety External Policy Risk Fanout Migration
- Phase 2.B Memory Tail Adapters Migration
- Phase 2.B Runtime Coherence / Live Proof Roadmap Split
- Phase 2.B Runtime Coherence Internal Proof
- Phase 2.B Live Governance Proof

The Phase 2.B closure summary (HN2.b/HN2.c/Phase 2.B Closure Update —
2026-05-20) and the post-Phase-2.B publicization sections remain in this
front door because they carry the active mode signal forward.
...
## C7A Product Skill Pack Top-10 - Closed 2026-05-25

Mode: `c7a_product_skill_pack_top10_closed`. Added exactly three static
certified packs (`competitor_review`, `data_analysis`, `app_requirements_spec`)
to reach ten strong workflows. Registry: entries=10 unique=10 c7a=3. Completion:
