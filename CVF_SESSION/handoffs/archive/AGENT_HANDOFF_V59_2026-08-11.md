...
Authorized guard-maintenance scope: project accepted ROLE-SOT-EVIDENCE-T0 material `6bcdeaca8` while preserving RABA park and P4-C1.
Protected paths:
...
- `CVF_SESSION/state/entries/roleSotEvidenceTopologyInvarianceT0Accepted20260908.json`
Operator authorization: compact ROLE-SOT-EVIDENCE-T0 review/closure and its one-path active-window registry expansion were explicitly approved; no successor is authorized automatically.
Rollback boundary: revert only this continuity projection; preserve accepted material `6bcdeaca8`, ADIF-0056 material `b8268100a`, RABA park `0767a16e5` and P4-C1 `b9bdba712`. No RABA successor, implementation or external effect is authorized.
## Claim Boundary
