...
export default function OperationsClient({ initialRole, initialUser }: OperationsClientProps = {}) {
    const [role, setRole] = useState<Role>(mapRole(initialRole));
    const [user, setUser] = useState(initialUser ?? 'Local browser');
