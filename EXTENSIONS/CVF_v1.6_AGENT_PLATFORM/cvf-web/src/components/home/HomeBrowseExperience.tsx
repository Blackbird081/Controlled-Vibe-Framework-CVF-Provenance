...
interface HomeBrowseExperienceProps {
    ...
    handleOutcomeQuickAction: (templateId: string) => void;
    handleSelectTemplate: (template: Template) => void;
    handleTryTemplate: (template: Template, config: Record<string, string>) => void;
    QUICK_TRY_CONFIGS: Record<string, Record<string, string>>;
    ...
    handleIntentRoute: (result: IntentRouteResult, userInput: string) => void;
    starterHandoff: GovernedStarterHandoff | null;
    handleOpenGovernedStarter: () => void;
    handleDismissGovernedStarter: () => void;
...
export function HomeBrowseExperience(props: HomeBrowseExperienceProps) {
    const {
        language,
        t,
        currentFolder,
        ...
        handleIntentRoute,
        starterHandoff,
        handleOpenGovernedStarter,
        handleDismissGovernedStarter,
        mockAiEnabled,
        hasAnyApiKey,
        bannerDismissed,
        handleDismissBanner,
    ...
    return (
        <>
            ...
            <div className="space-y-8 px-4 py-6 sm:px-6 flex flex-col">
                {/* 1. Task/Outcome Choices (Reordered above Hero) */}
                {!currentFolder && (
                    <OutcomeQuickActions
                    ...
                    <div className="grid gap-8 xl:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)] xl:items-center">
                        <div>
                            ...
                            <div className="mt-8 flex flex-wrap gap-3">
                                ...
                                <button
                                    onClick={() => window.dispatchEvent(new CustomEvent('cvf:openTour'))}
