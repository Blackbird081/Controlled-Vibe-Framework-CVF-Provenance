                ...
                {liveRunOutput ? (
                    <div className="space-y-6">
                        ...
                        <div className="rounded-xl border border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20 p-4">
                            <div className="text-sm font-semibold text-green-800 dark:text-green-200 mb-0.5">
                                {language === 'vi' ? 'Kết quả được khóa' : 'What gets locked'}
                            </div>
                            <div className="text-xs text-green-600 dark:text-green-400 mb-2">Freeze receipt</div>
