...
const DEFAULT_REQUEST: ArtifactExportRequest = {
  title: 'CVF HTML Presentation Candidate',
  ...
  sourceContent: [
    ...
    '## Claim Boundary',
    '',
    'This artifact is an HTML presentation candidate only.',
  ].join('\n'),
...
const LABELS = {
  ...
  vi: {
    title: 'Xuất Artifact',
    subtitle: 'Tạo bản HTML tự chứa, gắn với receipt để người xem biết nguồn và ranh giới.',
    boundary: 'Chỉ HTML. PDF, PNG, PPTX và claim tạo artifact có proof riêng vẫn được tách sang bước sau.',
    sourceTitle: 'Nguồn',
    outputTitle: 'Bản HTML',
    verificationTitle: 'Kiểm tra',
    titleLabel: 'Tiêu đề',
    pathLabel: 'Đường dẫn nguồn',
    memoryLabel: 'Loại ghi nhớ',
    statusLabel: 'Trạng thái',
    receiptLabel: 'Receipt anchor',
    boundaryLabel: 'Ranh giới claim',
    ...
    download: 'Tải HTML',
    print: 'Xem bản in',
    noOutput: 'Tạo bản HTML để xem trước tại đây.',
    noChecks: 'Các kiểm tra sẽ hiện sau khi tạo.',
    failed: 'Xuất thất bại',
    sourceHint: 'Dán nội dung nguồn đã được duyệt để render mà không đổi ý nghĩa.',
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              >
                ...
                <option value="POINTER_RECORD">POINTER_RECORD</option>
              </select>
            </div>
            <div>
